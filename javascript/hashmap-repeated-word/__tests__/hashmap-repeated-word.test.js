...
describe("FIRST REPEATED WORD TESTS", () => {
  ...
  it("1.successfuly return the first repeated when it's one letter.", () => {
  ...
  it("2.successfuly return the first repeated when it's two letters.", () => {
    let hashTable = new Hashmap(5000);
  ...
  it("3.successfuly return the first repeated word", () => {
    let hashTable = new Hashmap(5000);
