"use strict";
const {Hashmap,Node} = require("../tree-intersection");
...
describe("Tree-intersection Testing", () => {
  ...
  beforeAll(() => {
    ...
    treeOne = new BinaryTree(one);
    treeTwo = new BinaryTree(one2);
  });
  it("1.successfuly return the common nodes between two trees", () => {
    ...
    expect(hashTable.treeIntersection(treeOne, treeTwo)).toEqual(
      expectedResults
    );
  });
